	...
	<body>
		...
		<form action="/ch05/User4/proc/modify.jsp" method="post">
			<table border="1">
				<tr>
					<td>이름</td>
					<td><input type="text" name="name" value="<%= user4.getName() %>" placeholder="이름을 입력하시오"></td>
				</tr>
				<tr>
					<td>성별</td>
					<td>
				...
				<tr>
					<td>나이</td>
					<td><input type="text" name="age" value="<%= user4.getAge() %>" placeholder="나이를 입력하시오"></td>
				</tr>
				<tr>
					<td>주소</td>
					<td><input type="text" name="address" value="<%= user4.getAddress() %>" placeholder="주소를 입력하시오"></td>
				</tr>
				<tr>
