...
<%
	...
	try{
		...
		if(rs.next()){
			user1 = new User1VO();
			user1.setUser_id(rs.getNString(1));
			user1.setName(rs.getNString(2));
			user1.setHp(rs.getNString(3));
			user1.setAge(rs.getNString(4));
		}
	...
	<body>
		...
		<form action="./proc/modify.jsp" method="post">
			<table border="1">
				...
				<tr>
					<td>이름</td>
					<td><input type="text" name="user_name" value="<%= user1.getName() %>" placeholder="이름 입력"></td>
				</tr>
				<tr>
					<td>휴대폰</td>
