...
<html>
	...
	<body>
		...
		<form action="/ch05/User6/proc/modify.jsp" method="post">
			<table border="1">
				<tr>
					<td>SEQ</td>
				...
				<tr>
					<td>이름</td>
					<td><input type="text" name="name" value="<%= user6.getName() %>" placeholder="이름을 입력하시오"></td>
				</tr>
				<tr>
					<td>성별</td>
					<td>
						<label><input type="radio" name="gender" value="M" <%= "M".equals(user6.getGender()) ? "checked" : "" %> />남자</label>
						<label><input type="radio" name="gender" value="F" <%= "F".equals(user6.getGender()) ? "checked" : "" %> />여자</label>
					</td>
				</tr>
				<tr>
					<td>나이</td>
					<td><input type="text" name="age" value="<%= user6.getAge() %>" placeholder="나이를 입력하시오"></td>
				</tr>
				<tr>
					<td>주소</td>
					<td><input type="text" name="address" value="<%= user6.getAddress() %>" placeholder="주소를 입력하시오"></td>
				</tr>
				<tr>
